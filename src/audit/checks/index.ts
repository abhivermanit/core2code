 ...
 *
 * Security, Delivery, and Operations phases have no checks registered yet
 * (see phases.ts PHASE_ORDER) — they'll be filled in as later Audit Packs
 * add checks for those phases (see ROADMAP.md).
 */
